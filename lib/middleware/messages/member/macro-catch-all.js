...
module.exports = function catchAllMacro() {
  return async (req, res) => {
    ...
    // If the previous reply was a topic template, we're continuing the current topic.
    ...
    // If we're here -- the current topic has templates to reply with, the previous message the
