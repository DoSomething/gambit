...
module.exports = function parseRivescriptReply() {
  return async (req, res, next) => {
    ...
    const replyTopicId = req.rivescriptReplyTopic.id;
    logger.debug('macro not found for', { replyText, replyTopicId });

    try {
      logger.debug('currentTopicId', { id: req.currentTopicId });
      ...
      // TODO: this is buggy - if we're in the random topic this returns undefined.
      // And this should be a GET not FETCH
