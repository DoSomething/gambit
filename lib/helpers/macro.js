...
module.exports = {
  ...
  macros: {
    ...
    votingMethodEarly: () => getMacroForKey('votingMethodEarly'),
    votingMethodInPerson: () => getMacroForKey('votingMethodInPerson'),
    votingMethodMail: () =>  getMacroForKey('votingMethodMail'),
