 ...
 * @param {object} res
 */
module.exports.continueConversation = function (req, res) {
  if (!req.campaign) {
  ...
  return gambitCampaigns.postCampaignActivity(req)
    .then((gambitCampaignsRes) => {
      ...
      logger.debug('continueConversation', { signupId: req.signup.id }, req);
...
module.exports.confirmedContinue = function (req, res) {
  ...
  return exports.continueConversation(req, res);
};
