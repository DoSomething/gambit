...
function fetchById(topicId) {
  ...
  if (module.exports.isRivescriptTopicId(topicId)) {
    return Promise.resolve(module.exports.getTopicFromRivescriptTopicId(topicId));
  }
 ...
 * @return {Object}
 */
function getTopicFromRivescriptTopicId(topicId) {
  return {
    id: topicId,
    type: 'rivescript',
    name: topicId,
...
function isDefaultTopicId(topicId) {
  return topicId === config.defaultTopicId;
}
