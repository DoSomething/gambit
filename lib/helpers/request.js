...
function parseAskYesNoResponse(req) {
  return module.exports.getRivescriptReply(req, config.askYesNo.topicId)
...
function saidYes(req) {
  return req.askYesNoResponse === config.askYesNo.values.yes;
}
 ...
 */
function saidNo(req) {
  return req.askYesNoResponse === config.askYesNo.values.no;
}
