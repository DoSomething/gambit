...
async function executeSaidYesMacro(req, res) {
  try {
    ...
    if (module.exports.hasCampaign(req)) {
      logger.debug('posting campaign activity', { campaignId: req.campaign.id }, req);
      // Set the broadcastId to be used as source_detail for the signup.
      req.broadcastId = req.topic.id;
      await module.exports.postCampaignActivityFromReq(req);
    }
