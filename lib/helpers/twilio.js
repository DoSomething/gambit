...
function parseBody(req) {
  ...
  req.platformUserStateISOCode = module.exports.getMemberStateISOCode(req.body);
 ...
 */
function getMemberStateISOCode(requestBody = {}) {
  const country = 'US';
  const memberState = requestBody.FromState;
  const stateCodeData = stateISOCode.subdivision(country, memberState);
