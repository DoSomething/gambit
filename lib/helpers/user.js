...
function updateByMemberMessageReq(req) {
  ...
  underscore.extend(payload, module.exports.parseProfileUpdate(req.macro));
...
module.exports = {
   ...
   * @return {Object}
   */
  parseProfileUpdate: function parseProfileUpdate(macro) {
    return config.updatesByMacro[macro] || {};
  },
   ...
   */
  isSubscriber(user) {
    // @see note in this.parseProfileUpdate for TODOS if we ever support other platforms.
