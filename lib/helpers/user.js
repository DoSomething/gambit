 ...
 * @return {Promise}
 */
async function createPhotoPost({ userId, actionId, photoPostSource, photoPostValues }) {
  const payload = {
    northstar_id: userId,
    action_id: actionId,
 ...
 * @return {Promise}
 */
async function createTextPost({ userId, actionId, textPostSource, textPostText }) {
  const payload = {
    northstar_id: userId,
    action_id: actionId,
