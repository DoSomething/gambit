...
function updateByMemberMessageReq(req) {
  ...
  try {
    ...
    underscore.extend(payload, module.exports.getProfileUpdate(req.macro));
...
module.exports = {
   ...
   * @return {Object}
   */
  getProfileUpdate: function getProfileUpdate(macro) {
   ...
   */
  isSubscriber(user) {
    // @see note in this.getProfileUpdate for TODOS if we ever support other platforms.
