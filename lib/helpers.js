 ...
 */
module.exports.sendOutboundReply = function (req, res, text, template) {
  logger.debug('sendOutboundReply', { text, template });
  let outboundMessage;
...
module.exports.sendOutboundReplyForCampaign = function (req, res, campaign, template) {
  let text;
  ...
  return exports.sendOutboundReply(req, res, text, template);
};
