...
module.exports.getMessagePayload = function (phone, messageText, mediaUrl) {
  ...
  /**
   * We are sending Twilio messages directly from the FROM number. In this case, we have to
   * explicitly send a StatusCallback parameter to receive status updates on the message.
   */
